...
public static class SavWav {
	...
	public static AudioClip TrimSilence(List<float> samples, float min, int channels, int hz, bool _3D = false, bool stream = false) {
		int i;
		...
		if (samples.Count == 0) {
			Debug.LogWarning("TrimSilence AudioSample array is empty");
			return AudioClip.Create("", 1, channels, hz, stream);
		}
