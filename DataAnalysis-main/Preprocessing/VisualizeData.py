...
class VisualizeData:
    ...
    def __init__(self, path='D:/University-Masters/Thesis', process_movement=True, process_eye=True, process_face=True, process_button=True, process_external=True, process_heartbeat=True,
    ...
    def save_columns(self):
        ...
        for dr in dirs:
            if self.process_heartbeat:
                df = processSingleDataframe.processHeartBeat(unique_path =f"/{dr}/ProcessedCsv/{dr}_HeartBeat.csv")
